...
const Print = (props: { company?: any, id: number, type: string, checklistId: number }): React$Element<React$FragmentType> => {
    ...
    return (
        <div  className={style["print-checklist"]} >          
                            <div className="page" >
                                <header>
                                    <div className="row" >
                                        ...
                                        <div className="col-7">
                                            <div className="border-wrapper p-1">
                                                <div className="row">
                                                    ...
                                                    <div className="col-5">
                                                        <table className="bordered table-head cell-h-sm">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {/* {checklistData['a-tem-tap-ge-toyota']?.value.toString() === '1' ? 'X' : ''} */}
                                                                    </td>
                                                                <td>
                                                                    {/* {checklistData['a-tem-tap-ge-toyota']?.value.toString() === '0' ? 'X' : ''} */}
                                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-tem-kit-multimidia']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-tem-kit-multimidia']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                                <td>Faróis de Neblina</td>
                                                    <td>
                                                        {/* {checklistData['a-farois-neblina']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-farois-neblina']?.value.toString() === '0' ? 'X' : ''} */}
                                                        </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                                <td>Friso Lateral</td>
                                                                <td>
                                                        {/* {checklistData['a-friso-lateral']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-friso-lateral']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-band-porta-malas']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-band-porta-malas']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-sensor-estac']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-sensor-estac']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-macaneta-croma']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-macaneta-croma']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                                <td>Soleira</td>
                                                    <td>
                                                        {/* {checklistData['a-soleira']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-soleira']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-aplique-cromado']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-aplique-cromado']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-calha-chuva']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                            {/* {checklistData['a-calha-chuva']?.value.toString() === '0' ? 'X' : ''} */}
                                                        </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                                <td>{`Roda 16"`}</td>
                                                                <td>
                                                                    {/* {checklistData['a-roda-16']?.value.toString() === '1' ? 'X' : ''} */}
                                                                    </td>
                                                                <td>
                                                                    {/* {checklistData['a-roda-16']?.value.toString() === '0' ? 'X' : ''} */}
                                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-alto-falante']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-alto-falante']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-porca-anti-furto']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-porca-anti-furto']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        {/* {checklistData['a-radio-2din-blu']?.value.toString() === '1' ? 'X' : ''} */}
                                                    </td>
                                                    <td>
                                                        {/* {checklistData['a-radio-2din-blu']?.value.toString() === '0' ? 'X' : ''} */}
                                                    </td>
                                                                <td/>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div className="row">
                                                    <div className="col p-1 lh-150">
                                                        <div>
                                            {/* Pintura/Carroçaria: {checklistData['r-pin-carroc']?.value ?? ''} */}
