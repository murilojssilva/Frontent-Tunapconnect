...
import { Badge, Box, Button, Container, Divider, FormControl, Grid, InputLabel, MenuItem, Paper, Select, Stack, ToggleButtonGroup } from '@mui/material';
...
const TabsList = styled(TabsListUnstyled)(
    ({ theme }) => `
  min-width: 400px;
  border-bottom: 1px solid ${theme.palette.mode === 'dark' ? grey[900] : grey[200]};
  margin-bottom: 16px;
  display: flex;
  align-items: center;
  justify-content: center;
                        ...
                        <TabsUnstyled defaultValue={0}>
                            <TabsList>
                                {stages.stages.map((stage: any, index: any) => (
                                    <Tab value={index} key={index}>{stage.stage}</Tab>
                                ))}
                            </TabsList>
                                                ...
                                                {stage.tasks.map((task: any, index: any) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="center">
                                                            <Badge badgeContent={task.images.length} color="error">
                                                                <Photo color="action" />
                                                            </Badge>
                                                        </TableCell>
