...
import { Button, Divider, FormLabel, ListItemSecondaryAction, TextField, Typography } from '@mui/material';
        ...
        <Container maxWidth="lg" sx={{ mt: 12, mb: 12 }}>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={12} lg={12}>
                    <Stack direction='row'>
                        <Title> Checklist :  <InputHeader title={stages.checklist} /></Title>
                    </Stack>
                </Grid>
                <Grid item xs={12} md={12} lg={12}>
                    <Stack spacing={12}>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Button variant="contained" sx={{ ml: 2 }} onClick={e => addNewStage()}>Adicionar</Button>
